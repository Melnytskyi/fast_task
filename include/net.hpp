...
namespace fast_task::networking {
    ...
    public:
        ...
        // make_* – initiate async I/O; use async_* wrappers in coroutine/net.hpp.
        virtual future_ptr<std::vector<char>> make_read(uint32_t len) = 0;
        virtual future_ptr<void> make_write(const char* data, uint32_t len) = 0;
    };
    ...
    public:
        ...
        // make_accept – non-blocking accept; use async_accept in coroutine/net.hpp.
        future_ptr<tcp_network_blocking*> make_accept(bool ignore_acceptors = false);
        void _await();
