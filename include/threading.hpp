...
#ifndef FAST_TASK_INCLUDE_THREADING
#define FAST_TASK_INCLUDE_THREADING
#include "shared.hpp"
#include <atomic>
#include <chrono>
#include <functional>
...
namespace fast_task {
    ...
    public:
        friend class thread;
        friend id fast_task::this_thread::get_id() noexcept;
...
namespace std {
    template <>
    struct FT_API hash<fast_task::thread::id> {
        size_t operator()(const fast_task::thread::id& id) const noexcept {
